		...
		<body style="background-image: url('img/la.jpg');">
			...
			<section>	
				...
				<form class="form-container" action="#" method="POST">
				  	<h3>Liste Des Menu : <center><a href="AjouteMenu.php" class="btn btn-primary">Ajouter Menu</a></center></h3><br>
					<table>
				  		<thead>
					  <tr>
...
$res=mysqli_query($conn,"SELECT * from menu"); 
				  while($row=mysqli_fetch_array($res)){?> 
					  ...
					  <td><a name="Supprimer" href="AdminOperation/supprierMenu.php?id=<?php echo $row["id_m"]; ?>" class="btn btn-danger">Supprimer</a></td>
					  </tr>
					<?php }?>
				  </table><br>
				</form>
