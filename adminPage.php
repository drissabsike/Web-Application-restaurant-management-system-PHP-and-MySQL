...
$res=mysqli_query($conn,"SELECT * from client"); 
				  while($row=mysqli_fetch_array($res)){?> 
					  ...
					  <td><a name="Activer" href="AdminOperation/activate.php?id=<?php echo $row['id'];?>" class="btn btn-primary">Activer</a></td>
					  <td><a name="Supprimer" href="AdminOperation/supp.php?id=<?php echo $row['id'];?>" class="btn btn-danger">Supprimer le compte</a></td>
					   <td><a name="list" href="show.php?id=<?php echo $row['id'];?>" class="btn btn-info">liste des achats</a></td>
					  </tr>
					<?php }?>
				  </table><br>
