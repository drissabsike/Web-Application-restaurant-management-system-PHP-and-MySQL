<!DOCTYPE html>
	...
	<head>
		...
		<body>
		  			...
		  			<div class="container">
				  		<div class="row justify-content-end">
				  			<div class="col-lg-8 col-sm-4 col-8 header-top-right no-padding">
				  				...
				  				<ul><a href="registration.php">Register</a></ul>
				  				<ul><a href="Forgot.php">Forgot password</a></ul>
				  				</ul>
				  			</div>
				  		</div>			  					
		  			</div>
			...
			<!-- start banner Area -->
			<section class="banner-area" id="home" style="padding-top: 0px;">	
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-7"><br><br><br><br><br><br>
			...
			<section class="menu-area section-gap" id="coffee">
				<div class="container">
					...
					<button type="submit" name="Ajouter1" class="button button5">Ajouter au panier
					</button>
							</div>
						</div>												
					</div>
