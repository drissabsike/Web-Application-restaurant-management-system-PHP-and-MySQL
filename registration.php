			...
			<header id="header" id="home">
			    ...
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="home.php"><img src="img/mer.png" style="margin-left:-50px;" /></a>
				      </div>
				      <nav id="nav-menu-container" style="margin: -220px;">
				        <ul class="nav-menu">
				          <li class="menu-active"><a href="home.php" style="font-size:20px;">Home</a></li>
			...
			<section>	
				<section class="row justify-content-center">
					<section class="col-10 col-sm-6 col-md-4"> 
						<br><br><br><br>	
				<form class="form-container" action='cnx.php' method="POST">
				  <div class="form-group">
				    ...
				    <div class="form-group">
				  	<h3>Prenom:</h3>
				    <input  required="required" type="text" name="prenom" class="form-control">
				  </div>
				    <div class="form-group">
				  	<h3>Ville:</h3>
				    <select class="form-control" required="required" name="ville">
				  ...
				  <div class="form-group">
				  	<h3>Code Postale:</h3>
				    <input type="text" class="form-control" name="CodeP" required="required">
				  </div>
				    <div class="form-group">
				  	<h3>Email:</h3>
