		...
		<body style="background-image: url('img/la.jpg');">
			...
			<section>	
				...
				<form class="form-container" action="#" method="POST">
				  	<h3>Liste Des Produits: <center><a href="AjouteProduit.php" class="btn btn-primary">Ajouter Produit</a></center></h3><br>
					<table>
				  		<thead>
					  <tr>
				  ...
				  while($row=mysqli_fetch_array($res)){?> 
					  <tr>
					    ...
					    <td><?php echo $row['price'];?>dh</td>
                  		<td><img src="<?php echo $row["photo"]; ?>" alt="Smiley face" height="75" width="80"></td>
					  <td><a name="Supprimer" href="AdminOperation/supprierProduit.php?id=<?php echo $row["id_p"]; ?>" class="btn btn-danger">Supprimer</a></td>
					  </tr>
					<?php }?>
				  </table><br>
				</form>
